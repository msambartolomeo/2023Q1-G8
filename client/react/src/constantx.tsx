...
export const doctorUserPool_redirectURL = "https://dczngufo78uud.cloudfront.net/doctor/callback";
...
export const doctorPool_tokenEndpoint = `https://${doctorUserPool_cognito_domain}/oauth2/token`;